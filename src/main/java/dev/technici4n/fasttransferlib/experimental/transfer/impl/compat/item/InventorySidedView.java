package dev.technici4n.fasttransferlib.experimental.transfer.impl.compat.item;
...
public class InventorySidedView
	...
	@Override
	protected long insert(Context context, Transferable transferable, Item type, long maxAmount) {
		int size = this.size;
	...
	@Override
	protected long extract(Context context, Transferable transferable, Item type, long maxAmount) {
